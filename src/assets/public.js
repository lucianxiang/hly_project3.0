...
export const filterNonUnique = arr => arr.filter(i => arr.indexOf(i.fd_sfp_ID) === arr.lastIndexOf(i.fd_sfp_ID));
...
//获取日期差
export const getDateDifference = (s1, s2) => {
  let date1 = new Date(s1.replace(/-/g, "/"));
  let date2 = new Date(s2.replace(/-/g, "/"));
  var days = Math.abs(date2.getTime() - date1.getTime());
