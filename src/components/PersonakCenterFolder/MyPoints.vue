...
<script>
  ...
  export default{
    ...
    created(){
      ...
      if(this.user){
        this.initData(1,this.user.sm_ui_UserCode,'')
      }
    },
    methods: {
      //分页
      handleCurrentChange(num){
        this.initData(num,this.user.sm_ui_UserCode,this.typeID)
      },
      //初始化
      ...
      //查询
      search(){
        this.initData(1,this.user.sm_ui_UserCode,this.typeID)
      },
      //总积分查询
      allSearch(){
        this.initAllData(this.user.sm_ui_UserCode,this.allTypeID)
      }
    },
  }
</script>
