            ...
            <div class="MyticketOrderDetailsWrapContentDetalisLeft">
              <div class="MyticketOrderDetailsWrapContentDetalisLeftTop">
                ...
                <div class="MyticketOrderDetailsWrapContentDetalisLeftParameter clearfix">
                  ...
                  <span>车位数: {{hotelOrderDetail.ht_or_CarSeats}} 个</span>
                  <span>房间号: {{hotelOrderDetail.ts_to_HouseNumber}}</span>
                  <span>凭证码: {{hotelOrderDetail.ht_or_Password}}</span>
                  <span>使用状态: {{hotelOrderDetail.ht_or_UseState | useStatus}}</span>
                </div>
                <div class="AllMoney clearfix">
                  <strong>订单总金额: ￥{{hotelOrderDetail.ht_or_FullPrice*hotelOrderDetail.ht_or_TicketCount}}</strong>
                  <span>支付方式: {{hotelOrderDetail.ht_or_PayWay}}</span>
                </div>
              </div>
